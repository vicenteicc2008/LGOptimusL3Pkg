...
EFI_GRAPHICS_OUTPUT_BLT_PIXEL        mGraphicsEfiColors[16] = {
  ...
  {0x00, 0xc6, 0x18, 0x00},  // LIGHTGRAY, silver
  {0x00, 0x30, 0x30, 0x00},  // DARKGRAY - BRIGHT BLACK, silver
  {0x00, 0x00, 0x1f, 0x00},  // BLUE
  {0x00, 0xff, 0x00, 0x00},  // LIME
  {0x00, 0x07, 0xff, 0x00},  // CYAN
  {0x00, 0xf8, 0x00, 0x00},  // RED
  {0xff, 0x00, 0xff, 0x00},  // FUCHSIA
  {0x00, 0xff, 0xe0, 0x00},  // YELLOW
